...
## Project Structure
    ...
    ├── restaurant_recruitm_43683  # Django project configurations
...
1. Clone this repo and `cd restaurant_recruitm_43683`
...
2. Clone this repo and `cd restaurant_recruitm_43683`
